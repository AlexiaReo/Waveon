...
export const FavoritesPage: React.FC<FavoritesPageProps> = ({ songs, handleSongSelect, onToggleLike }) => {
    return (
                        ...
                        >
                            ...
                            <td className="p-3 align-middle">
                                <div className="flex flex-col justify-center">
                                    ...
                                    <span className="text-gray-400 text-xs mt-1 block">{song.artist?.name || 'Unknown Artist'}</span>
                                </div>
                            </td>
